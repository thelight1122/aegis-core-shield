...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    content: (
      <p>
        AEGIS operates in three modes. We&apos;ll focus on <strong>Agentic IDE</strong> for
        managing governed agent swarms.
      </p>
    ),
    placement: 'bottom',
  },
  {
    ...
    content: (
      <p>
        Spawn new agents here. Try clicking <strong>+ Create Agent</strong> to spin up a new
        swarm member.
      </p>
    ),
    placement: 'right',
  },
  {
    ...
    content: (
      <p>
        Assign tools like <strong>fs-reader</strong> or <strong>fs-writer</strong> to grant
  ...
  },
  {
    ...
    content: (
      <p>
        Select the local folder where agents will operate. Click <strong>Browse</strong> to
        choose a folder.
      </p>
    ),
    placement: 'bottom',
  },
  {
    ...
    content: (
      <p>
        All prompts pass through the Discernment Gate. Select an agent and try{' '}
        <code>!read package.json</code>.
      </p>
    ),
    placement: 'bottom',
  },
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="d-flex align-items-center gap-3">
          ...
          <button
            ...
            onClick={() => {
              setMode('aegis-ide');
              window.setTimeout(() => startTutorial(tutorialSteps), 300);
            }}
          >
